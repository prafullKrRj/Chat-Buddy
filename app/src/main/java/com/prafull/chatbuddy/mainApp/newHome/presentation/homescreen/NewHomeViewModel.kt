...
class NewHomeViewModel : ViewModel(), KoinComponent {
    ...
    fun updateNewPrompt(normalHistoryMsg: NormalHistoryMsg) {
        currPrompt = normalHistoryMsg.copy(
                model = currModel.generalName
        )
    }

    var currPrompt by mutableStateOf(NormalHistoryMsg())
